...
void MainWindow::saveNotes(){
    ...
    if (ui->emoStateVerySad->isChecked()) emotionalState = "Very Sad";
    else if (ui->emoStateSad->isChecked()) emotionalState = "Sad";
    else if (ui->emoStateNeutral->isChecked()) emotionalState = "Neutral";
    else if (ui->emoStateHappy->isChecked()) emotionalState = "Happy";
    else if (ui->emoStateVeryHappy->isChecked()) emotionalState = "Very Happy";

  
    QString overallFeeling;
    if (ui->overallFeelingVerySad->isChecked()) overallFeeling = "Very Sad";
    else if (ui->overallFeelingSad->isChecked()) overallFeeling = "Sad";
    else if (ui->OverallFeelingNeutral->isChecked()) overallFeeling = "Neutral";
    else if (ui->overallFeelingHappy->isChecked()) overallFeeling = "Happy";
    else if (ui->overallFeelingVeryHappy->isChecked()) overallFeeling = "Very Happy";
